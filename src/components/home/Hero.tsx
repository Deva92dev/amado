            ...
            <div className="bg-card/10 backdrop-blur-3xl p-8 md:p-12 rounded-3xl border border-border/20 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 transform transition-all duration-700 delay-700 animate-slideUpFromBottom">
                  <Button className="group relative btn-brand px-8 py-4 text-lg font-semibold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-brand-accent/25 hover:ring-2 hover:ring-brand-accent/50 w-fit cursor-pointer">
                  ...
                  <Button className="group px-8 py-4 text-lg font-semibold text-foreground border-2 border-border/30 rounded-[--radius] bg-card/5 backdrop-blur-sm hover:bg-accent/20 hover:border-border/50 transition-all duration-300 hover:scale-105 hover:shadow-lg w-fit cursor-pointer">
                    <span className="flex items-center gap-2">
                      Watch Story
                      <PlayIcon className="w-4 h-4 transition-transform duration-300 group-hover:scale-110" />
                    </span>
                  </Button>
                </div>
              </div>
